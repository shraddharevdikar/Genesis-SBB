        ...
        <section className="grid grid-cols-2 md:grid-cols-4 gap-4" id="stats-dashboard">
          <div className="bg-[#0F0F11] p-4 rounded border border-[#262626]">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[10px] font-mono text-[#D4D4D8] bg-[#1C1917] border border-[#44403C] px-1.5 py-0.5 rounded">GEN-000.4.4</span>
            </div>
            <p className="text-xl font-light text-white mt-2 font-mono">5 Packages</p>
            <p className="text-[11px] text-[#A3A3A3] mt-1 flex items-center gap-1">
              <span>Identity, Config, Logger, Shared & DB Done</span>
            </p>
          </div>
          ...
          <div className="bg-[#0F0F11] p-4 rounded border border-[#262626]">
            ...
            <p className="text-xl font-light text-white mt-2 font-mono">67 Files</p>
            <p className="text-[11px] text-[#737373] mt-1">Identity (15) + Config (9) + Logger (12) + Shared (14) + DB (17)</p>
          </div>
